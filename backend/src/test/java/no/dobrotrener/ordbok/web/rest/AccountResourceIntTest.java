...
import no.dobrotrener.ordbok.config.Constants;
import no.dobrotrener.ordbok.domain.Authority;
import no.dobrotrener.ordbok.domain.User;
import no.dobrotrener.ordbok.repository.AuthorityRepository;
import no.dobrotrener.ordbok.repository.UserRepository;
import no.dobrotrener.ordbok.security.AuthoritiesConstants;
import no.dobrotrener.ordbok.service.MailService;
import no.dobrotrener.ordbok.service.UserService;
import no.dobrotrener.ordbok.service.dto.PasswordChangeDTO;
import no.dobrotrener.ordbok.service.dto.UserDTO;
import no.dobrotrener.ordbok.web.rest.errors.ExceptionTranslator;
import no.dobrotrener.ordbok.web.rest.vm.KeyAndPasswordVM;
import no.dobrotrener.ordbok.web.rest.vm.ManagedUserVM;
