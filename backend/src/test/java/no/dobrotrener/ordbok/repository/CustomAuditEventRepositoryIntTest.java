...
import no.dobrotrener.ordbok.config.audit.AuditEventConverter;
import no.dobrotrener.ordbok.domain.PersistentAuditEvent;
...
import static no.dobrotrener.ordbok.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
